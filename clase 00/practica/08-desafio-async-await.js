/** Realizaremos una fn que reciba un objeto y muestre cada dos segundos sus claves y valores 
*   en el siguiente formato: [clave, valor] -  Usar: entries, async y await  
**/
