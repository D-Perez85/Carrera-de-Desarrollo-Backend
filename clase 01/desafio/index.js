...
console.log(edad); // 25
console.log(precio); // 99.90
console.log(misSeriesFavoritas); // lista de series
console.log(misPeliculasFavoritas); // detalle de peliculas

edad += 1;
console.log(edad); // 26

misSeriesFavoritas.push("Los favoritos de midas");
console.log(misSeriesFavoritas); // lista de series modificado
